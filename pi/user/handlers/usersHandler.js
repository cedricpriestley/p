...
/**
  ...
  */
userHandler.initialise = function (resourceConfig) {
  // console.log(jsonApi)
  ...
  userHandler.ready = true
}

/**
    Search for a list of resources, given a resource type.
    */
userHandler.search = function (request, callback) {
  const self = this
...
/**
  ...
  */
userHandler.delete = function (request, callback) {
...
/**
  ...
  */
userHandler.update = function (request, partialResource, callback) {
  // Find the requested resource
  this.find(request, (err, theResource) => {
    if (err) return callback(err)
...
/**
  ...
  */
userHandler._sortList = (request, list) => {
