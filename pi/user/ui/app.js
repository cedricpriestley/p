...
const renderData = () => {
  ...
  people.forEach((person, index) => {
    ...
    mainDiv.appendChild(personH1) //append the h1 to the main elemen
...
updateFormButton.addEventListener("click", updateData) //trigger update data function when updateButton is clickedt
